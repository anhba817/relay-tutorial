...
+  // feature (T008). The channel-control chapter and the user-surface chapter add fourteen routes, so the closing
+  // number is 38.
+  //
...
+  it("has grown from the isolation gauntlet's 24 by exactly the routes this feature adds", () => {
