...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-17/the-message-that-is-not-only-text",
    languages: {
      en: "/part-3/chapter-17/the-message-that-is-not-only-text",
      vi: "/vi/part-3/chapter-17/the-message-that-is-not-only-text",
    },
  },
};
