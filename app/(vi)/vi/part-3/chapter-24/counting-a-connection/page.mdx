...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-24/counting-a-connection",
    languages: {
...
<Figure caption="Một socket sống năm giây tốn một phút. Một socket mở từ 00:00:59 đến 00:01:01 tốn hai — nó hiện diện trong hai phút dương lịch, và đơn vị chính là cái phút mà nó hiện diện." code={figWhatABucketIs} />
...
<Figure caption="Giao thức gửi phần chênh cần giao ít nhất một lần, cần một danh tính thông điệp để khử trùng lặp, và cần chỗ chứa những gì chưa gửi được. Giao thức gửi tổng không cần cả ba." code={figTotalsNotDeltas} />
...
<Figure caption="Hai chặng, hai hình dạng. api nói HTTP và trả lời 402. Client nói WebSocket và nhận đúng từ vựng của socket." code={figTwoHops} />
...
<Figure caption="Một cú đóng sạch sẽ và một gateway bị giết đi tới cùng một trạng thái. api không bao giờ biết cái nào đã xảy ra, và không có gì trong thiết kế phụ thuộc vào việc biết." code={figWhatTheApiCannotTell} />
...
@@ -926,30 +930,44 @@ describe("the socket's limits", () => {
     reconnected.close();
   });
