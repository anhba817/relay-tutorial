...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-06/commit-and-publish-are-two-instants",
    languages: {
      en: "/part-3/chapter-06/commit-and-publish-are-two-instants",
      vi: "/vi/part-3/chapter-06/commit-and-publish-are-two-instants",
    },
  },
};
