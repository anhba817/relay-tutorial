...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-08/the-channel-a-customer-controls",
    languages: {
      en: "/part-3/chapter-08/the-channel-a-customer-controls",
      vi: "/vi/part-3/chapter-08/the-channel-a-customer-controls",
    },
  },
};
