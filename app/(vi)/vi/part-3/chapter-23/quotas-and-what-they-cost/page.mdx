...
export const metadata = {
  ...
  description:
    "Quota là mức sử dụng theo tháng, không phải rate limit. Chương này dùng counter không increment được, enforce tại write boundary, phát event khi crossing và gửi email cảnh báo.",
  alternates: {
...
Quota cần answer về tháng nào, điều gì bị tính và chi phí khi vượt. Nó không thể là query
đếm lại mọi message mỗi write, cũng không được nhầm với limit theo thời gian ngắn.

## Query chúng ta không viết
...
## Nó được enforce ở đâu, và tại sao không ở nơi bạn nghĩ
