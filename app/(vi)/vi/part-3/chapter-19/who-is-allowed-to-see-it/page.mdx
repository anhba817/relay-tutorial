...
cái thứ hai. `message.updated`, `message.deleted`, `membership.changed` và `typing` là bốn từ đã khai
báo mà phía sau không có gì vào lúc chương này ra mắt — chương 3.20 cho từ thứ ba một nơi
sản xuất và 3.21 cho từ thứ tư, còn lại hai. Việc gọi tên chúng ra ở đây là cố ý — bản đặc tả của chính
...
lại của lời hứa mà chương 2.6 đưa ra. Liệu typing có tái dùng được plumbing của fan-out hay
không chính là câu hỏi mà nửa câu ấy để ngỏ, và chương này mới chỉ khép được nửa phần
presence.

**Chương 3.21 đã trả lời: không.** Nó đếm lại các điểm ở đoạn trên và tìm thấy bảy điểm được
định kiểu, chứ không phải ba như chương này viết — nên typing cũng lấy một ngữ pháp subject
thứ tư, và lời hứa của 2.6 được thu hồi chứ không được giữ.
