...
Một người **tham gia channel trong lúc đang kết nối** sẽ không hiện online với thành viên của
channel đó cho tới khi họ kết nối lại. Tập subscribe được lấy đúng một lần, lúc kết nối, từ session
...
kết nối lại — nhưng đó là một lần đọc lại mà session layer còn nợ, không phải một cơ chế chương này
có thể dựng.
