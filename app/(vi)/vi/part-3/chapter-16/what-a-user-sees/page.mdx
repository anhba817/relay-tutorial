...
**145 lần, và test lane không thể nói cho bạn biết.** Một triệu tin nhắn không phải con số lạ
với một nền tảng chat — đó là năm đầu tiên của một khách hàng cỡ vừa. 0.87 ms của lane không
sai; nó là phép đo trên một database nhỏ đến mức quét tuần tự còn rẻ hơn tra index, điều vừa
đúng vừa vô dụng.
...
và không cái nào là việc của tính năng này.
