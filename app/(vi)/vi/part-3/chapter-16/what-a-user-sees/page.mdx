...
+        };
    ...
    *
-   * This was a plain insert until the isolation gauntlet, which is fine for a fixture and
...
+  // The isolation gauntlet recorded that as its own finding — a REST-sent message reaches no socket,
