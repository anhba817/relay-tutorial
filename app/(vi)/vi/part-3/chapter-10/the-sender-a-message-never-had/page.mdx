...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-10/the-sender-a-message-never-had",
    languages: {
      en: "/part-3/chapter-10/the-sender-a-message-never-had",
      vi: "/vi/part-3/chapter-10/the-sender-a-message-never-had",
    },
  },
};
...
+    // exercise recorded. It had TWO causes and the sender chapter removed one: the api still
...
@@ -491,7 +547,33 @@ describe("the repository's own refusals", () => {
