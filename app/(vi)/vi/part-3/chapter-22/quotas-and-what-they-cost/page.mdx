...
export const metadata = {
  ...
  alternates: {
    canonical: "/vi/part-3/chapter-22/quotas-and-what-they-cost",
    languages: {
      en: "/part-3/chapter-22/quotas-and-what-they-cost",
      vi: "/vi/part-3/chapter-22/quotas-and-what-they-cost",
    },
  },
};
...
<Trap title="Một lần gửi bằng key tính vào tin nhắn — và từ chương 3.17, tính cả vào một active user">
Khi chương này được viết, một lần gửi REST xác thực bằng key không mang user — vô danh
theo thiết kế từ chương 3.3, vì một API key phía server không phải một con người. Nó tốn
một tin nhắn trên quota tin nhắn và không tính vào ai cả.

**Chương 3.17 đổi nửa sau.** Một key giờ phải nêu tên một **bot user**: một danh tính mà
khách hàng tự tạo, tự đặt tên và tự mô tả cho phần mềm của họ. Nên lần gửi tốn một tin
nhắn *và* tính vào một active user — đúng cái điều mà đoạn dưới đây phản đối, và lập luận
đó vẫn đúng với cái mà nó nói tới.

Phương án bị loại là một user **tổng hợp**, do nền tảng bịa ra, sẽ làm phồng lên cái
dimension mà khách hàng bị đo mà không ai yêu cầu. Một bot thì được **khai báo**: khách
hàng quyết định nó tồn tại và thấy được nó trên hoá đơn. Làm phồng một dimension bằng một
danh tính thật mà ai đó đã yêu cầu là một hành động khác với việc bịa ra một cái thay họ.

Một hệ quả, vì chương 3.17 vạch ranh giới ở đây: một bot **bị tính tiền** như active user
và **được miễn** khỏi cái ngưỡng vốn từ chối tin gửi. Phần mềm của chính khách hàng không
thể khoá người của họ khỏi việc gửi tin.
</Trap>
