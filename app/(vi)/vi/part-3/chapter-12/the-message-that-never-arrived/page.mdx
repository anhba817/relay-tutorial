...
Nó thuộc về chương 3.19, nhưng không phải vì lý do được viết ở đây trước tiên. Hoá ra presence
không cần một membership push nào cả: nó cần tập channel của chủ thể tại đúng thời điểm chuyển
trạng thái, và `POST /internal/session` vốn đã trả về tập đó. Sự cũ kỹ vẫn là cùng một khiếm
khuyết — một channel được tham gia giữa chừng một kết nối thì vô hình cho tới khi socket mở lại —
nhưng đó là một lần đọc lại mà session layer còn nợ, không phải một cơ chế chương ấy có thể dựng
tiện thể trên đường đi.
...
membership không hề được đọc lại. Chương 3.19 thừa hưởng khiếm khuyết chứ không thừa hưởng chẩn
đoán: presence đọc tập channel của chủ thể tại thời điểm chuyển trạng thái từ chính cái snapshot
cũ ấy, nên một channel được tham gia giữa chừng cũng vô hình ở đó — nhưng không có gì trong chương
ấy cần tới một membership push mới chạy được, nên nó để điều khoản y nguyên chỗ nó tìm thấy thay
vì sửa tiện đường. Chương 3.20 là nơi điều khoản này đóng lại, và nó đóng cả hai nửa cùng lúc:
chính lần đọc lại khiến một thành viên bị xoá ngừng nhận tin cũng là thứ khiến một lần tham gia
giữa chừng hiện ra với presence.
...
Presence nằm ngoài phạm vi chương này, và điều đó được nói ra chứ không để im lặng ngụ ý:
FR-RTM-06 và FR-RTM-07 thuộc chương 3.19, còn động từ thứ ba của FR-CHN-05 — quan sát presence —
vẫn chưa được dựng. Điều khoản ấy có ba động từ. Đọc và gửi đã đứng vững từ trước chương này và
vẫn vững sau nó; chương này trao cho động từ thứ hai phần live của nó, và để động từ thứ ba đúng
nơi chương 3.17 đã để.
