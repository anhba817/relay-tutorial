...
<Trap title="Một derivation rỗng trông y hệt một bề mặt sạch sẽ">
...
<Why title="Vì sao là một danh sách kèm lý do thay vì một pattern">
...
<Why title="Vì sao là không thể phân biệt, chứ không chỉ là bị từ chối">
...
<Trap title="Hai lần thử kiểm chứng từ bên ngoài bộ test đều thất bại">
...
<Why title="Vì sao các con số được ghi lại chứ không được assert">
...
<Trap title="`::text` là thứ gánh việc, và con bug chỉ đọc được nhờ tình cờ">
...
<Why title="Vì sao thêm `environment_id` sẽ là phần vá sai">
...
<Trap title="Mười hai test timeout ở đúng 5000ms, và không cái nào liên quan đến tenancy">
...
<Why title="Ba lần tái tạo đo được gì, và không đo được gì">
