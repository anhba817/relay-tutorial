...
this chapter ships there is no code path that re-reads it; chapter 3.20 builds one, and it goes
...
Chapter 3.20 is where it closes, and it closes both halves at once: the same re-read that stops
