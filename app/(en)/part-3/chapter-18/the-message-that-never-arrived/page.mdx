...
It belongs to chapter 3.19. Presence needs the same missing mechanism — something that tells a
...
snapshot with no re-read. Chapter 3.19 needs the same thing built for presence.
