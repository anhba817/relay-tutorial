...
<Why title="Eleven of those fences no longer exist">

In the order this book was first written, eleven of the files below changed by **exactly one
word** — a chapter citation corrected because the work it pointed at had moved. Zero
substantive lines, eleven fences with no subject, and a whole commit to produce them.
...
chapters sit, and a reorder corrects nothing. **The commit that renumbered twenty-two
citations was skipped, and the eleven fences went with it.**

What is left below is eight files that changed for a reason — the `banned` field the session
response now carries, and the stubs that had to say so. Three of the eleven were nothing
...
So eight fences with a subject, and the eight are these:
