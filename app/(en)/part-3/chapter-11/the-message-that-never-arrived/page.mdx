...
export const metadata = {
  ...
  alternates: {
    canonical: "/part-3/chapter-11/the-message-that-never-arrived",
    languages: {
      en: "/part-3/chapter-11/the-message-that-never-arrived",
      vi: "/vi/part-3/chapter-11/the-message-that-never-arrived",
    },
  },
};
