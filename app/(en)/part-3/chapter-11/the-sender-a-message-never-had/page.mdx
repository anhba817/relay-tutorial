...
this chapter ships.
**The outbox event test as this chapter finds it**, and then what this chapter adds to it.
...
**And the exemption test, whole**, before the entry below joins its list.
...
```
**The history suite this chapter extends**, in full first.
...
```
**And the idempotency suite beside it**, the same way.
