...
@@ -39,179 +299,48 @@ export default tseslint.config(
...
The scattered ones are still there, and one of them got sharper rather than being
left alone. `repository.itest.ts`'s membership assertion read `false` for three
