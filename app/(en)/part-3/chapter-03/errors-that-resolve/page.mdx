...
```
**The file the diff below amends**, as it stands when this chapter opens. It is published whole
here because five later chapters change it, and every one of their diffs is anchored on these bytes.


```ts title="services/gateway/src/session.itest.ts"
