...
exists to emit it. FR-045 leaves the exemption to whichever chapter builds one.
...
<Trap title="There is no batch send, and that is why FR-008 was rewritten">
...
Which is why FR-046 says a development environment's limits are meant to be
