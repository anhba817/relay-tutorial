...
import { figTwoDirections, figTwoPositions, figBoundaryBurst, figOutboxThrice } from "./figures";
...
<Figure caption="The fixed window's cost, and what it buys." chart={figBoundaryBurst} />
...
<Figure caption="The middleware chain, and why each limiter sits where it does." chart={figTwoPositions} />
...
<Figure caption="One outage, two limiters, two opposite answers — and both are right." chart={figTwoDirections} />
