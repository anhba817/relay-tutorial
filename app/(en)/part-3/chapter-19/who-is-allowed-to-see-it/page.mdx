...
FR-RTM-10's staleness wearing a different hat, and it is unfixed here on purpose — chapter 3.20
...
**Chapter 3.20 pays it**, and the staleness goes with it: subscribing to a channel's presence
...
**Chapter 3.21 answered it: no.** It re-derived the count in the paragraph above and found
