...
> to the list of codes with nowhere to point, and the connection-metering chapter declined to add a
...
it — the presence chapter asks "is anybody still connected?" of a single key's existence
...
**The email transport.** The disablement notifications the retry-and-disable chapter wrote and
nothing delivered are built and shipping under this chapter's tag — the code is
here, `delivered_at` is being set, and the retry-and-disable chapter's backlog has drained. The chapter that
